...
urlpatterns = [
    ...
    path('api/corpus/<str:corpus_id>/document/<str:document_id>/get-kvp/<str:key>', manager_views.api_document_get_kvp),
    path('api/corpus/<str:corpus_id>/document/<str:document_id>/set-kvp/<str:key>', manager_views.api_document_set_kvp),
    ...
    path('corpus/<str:corpus_id>/document/<str:document_id>/view/<str:view_type>/<str:view_name>/', manager_views.document_view),
