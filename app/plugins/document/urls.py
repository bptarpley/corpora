...
urlpatterns = [
    ...
    path('corpus/<str:corpus_id>/Document/<str:document_id>/page/<str:ref_no>/image/<str:image_key>/<str:region>/<str:size>/<str:rotation>/<str:quality>.<str:format>', document_views.get_document_image),
    ...
    path('api/corpus/<str:corpus_id>/Document/<str:document_id>/kvp/<str:key>', document_views.api_document_kvp),
