/* The variable below tracks how the TinyMCE editor converts certain
unicode characters to their ampersand code equivalents, i.e. the
extra space character (160) to &nbsp;. This string is structured
according to TinyMCE specs: "Odd items are the character code, and
even items are the names of the character code," from:

https://www.tiny.cloud/docs/tinymce/5/content-filtering/#_entities

For now, we're modifying the default value by removing the encoding
of ndash and mdash characters.
 */
const entity_renderings = '160,nbsp,161,iexcl,162,cent,163,pound,164,curren,165,yen,166,brvbar,' +
...
'lrm,8207,rlm,8216,lsquo,8217,rsquo,8218,sbquo,' +
